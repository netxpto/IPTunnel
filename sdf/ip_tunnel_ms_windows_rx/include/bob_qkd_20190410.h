...
public:
	...
	BobQKD(initializer_list<Signal*> inputSignals, initializer_list<Signal*> outputSignals, string sFolderName, t_integer maxSamplesToProcessAtOnce, unsigned long int buffersSize) :
		SuperBlock(inputSignals, outputSignals),
		folderName{ sFolderName },
		maximumECSyndromeSize{ maxSamplesToProcessAtOnce },
...
private:
	...
	TimeContinuousAmplitudeDiscreteReal BER_In{ "S01_BER_In.sgn", buffSize };
	TimeContinuousAmplitudeDiscreteReal Data_In{ "S02_Data_In.sgn", buffSize };
	Binary Basis_In{ "S03_Basis_In.sgn", buffSize };
	Binary TransmissionMode_In{ "S04_TransmissionMode_In.sgn", buffSize };
	Message Messages_In{ "S05_Messages_In.sgn", buffSize };

	// Internal
	TimeContinuousAmplitudeDiscreteReal DataIn{ "S07_DataIn.sgn", buffSize };
	Binary BasisIn{ "S08_DataIn.sgn", buffSize };
	TimeContinuousAmplitudeDiscreteReal BasisFromAlice{ "S09_BasisFromAlice.sgn", buffSize };
	Binary SiftedKeys{ "S10_DataRecon.sgn", buffSize };
	Binary DataRecon{ "S11_DataRecon.sgn", buffSize };
	Binary ErrorCorrectionIn{ "S11b_ErrorCorrectionIn.sgn", buffSize };
	TimeContinuousAmplitudeDiscreteReal BasisToSend{ "S12_BasisToSend.sgn", buffSize };
	...
	TimeContinuousAmplitudeDiscreteReal SeedsFromAlice{ "S16_SeedsFromAlice.sgn", buffSize };
	...
	TimeContinuousAmplitudeDiscreteReal BERToEC{ "S16d_BERToEC.sgn", buffSize };
	TimeContinuousAmplitudeDiscreteReal BERToPA{ "S16e_BERToPA.sgn", buffSize };
